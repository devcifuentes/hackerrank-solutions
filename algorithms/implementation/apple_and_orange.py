...
For example, Sam's house is between s = 7 and t = 11. The apple tree is located at a = 5
and the orange at b = 15. There are m = 3 apples and n = 2 oranges. Apples are thrown
apples = [−2, 2, 1] units distance from a, and oranges = [5, −6] units distance.
Adding each apple distance to the position of the tree, they land at [5 − 2, 5 + 2, 5 + 1] = [3, 7, 6].
Oranges land at [15 + 5, 15 − 6] = [20, 9]. One apple and two oranges land in the inclusive range 7 − 10
so we print
1
2
...
def countApplesAndOranges(s, t, a, b, apples, oranges):
    ...
    orange_in = 0
    for apple in apples:
        if apple >= apple_poss[0] and apple <= apple_poss[1]:
            apple_in += 1
    for orange in oranges:
        if orange <= orange_poss[0] and orange >= orange_poss[1]:
            orange_in += 1
    print(apple_in)
    print(orange_in)
